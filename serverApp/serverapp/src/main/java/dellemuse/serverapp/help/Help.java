...
public class Help {
	...
	public static final String INSTITUTION_LIST = "institution-list";
	...
	public static final String SITE_ROLES_LIST = "site-roles-list";
	...
	public static final String SITE_REPORTS = "site-reports";
