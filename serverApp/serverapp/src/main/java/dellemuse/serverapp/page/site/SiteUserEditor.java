...
public class SiteUserEditor extends DBObjectEditor<User> implements InternalPanel {
	...
	public void onInitialize() {
		...
		EditButtons<User> buttons = new EditButtons<User>("buttons", this.form, getModel()) {
			...
			public void onEdit(AjaxRequestTarget target) {
				SiteUserEditor.this.onEdit(target);
			}

			public void onCancel(AjaxRequestTarget target) {
				SiteUserEditor.this.onCancel(target);
			}

			public void onSave(AjaxRequestTarget target) {
				SiteUserEditor.this.onSave(target);
			}
