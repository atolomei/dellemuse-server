...
public abstract class BrandedBasePage extends WebPage {

	private static final long serialVersionUID = 1L;

	static private Logger logger = Logger.getLogger(BrandedBasePage.class.getName());
	...
	// private static final ResourceReference KBEE_JS =
	// BasePage.getJavaScriptKbeeResourceReference();
	...
	private static final ResourceReference CSS = new CssResourceReference(BrandedBasePage.class, "./dellemuse.css");
	 ...
	 * 
	 * 
	 * HiddenField<String> csrfToken = new HiddenField<>("csrf",
	 * Model.of(csrfTokenValue)); form.add(csrfToken);
	 * 
	 * 
	 * 
	 * 
