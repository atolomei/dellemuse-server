...
public abstract class ObjectPage<T extends DelleMuseObject> extends BasePage {
	...
	public void onInitialize() {
		...
		if (!this.hasAccessRight(getSessionUser())) {
			...
			Panel panel = getNoAuthorizedErrorPanel("internalPanel");
			internalPanelContainer.add(panel);
	...
	private void addNavigator() {
		...
		this.navigatorContainer.add(new org.apache.wicket.AttributeModifier("class", (isDarkTheme() ? " hasplayer " : "text-bg-light ") + " container-fluid border-top"));
