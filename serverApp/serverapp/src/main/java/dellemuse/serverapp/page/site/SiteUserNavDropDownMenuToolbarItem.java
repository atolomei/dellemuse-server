...
public class SiteUserNavDropDownMenuToolbarItem extends DropDownMenuToolbarItem<User> {

	private static final long serialVersionUID = 1L;

	public SiteUserNavDropDownMenuToolbarItem(String id, IModel<User> model, IModel<String> title, Align align) {
			...
			public MenuItemPanel<User> getItem(String id) {
				...
				return new AjaxLinkMenuItem<User>(id, getModel()) {
					...
					public void onClick(AjaxRequestTarget target) {
						fire(new MenuAjaxEvent(ServerAppConstant.site_user_editor, target));
					}
