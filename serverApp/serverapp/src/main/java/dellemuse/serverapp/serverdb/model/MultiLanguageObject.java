...
public abstract class MultiLanguageObject extends DelleMuseObject {
	...
	/**
	 * language -> it is the language of this content
	 * masterLanguage -> it is the language used by all
	 * the TranslationRecords associated with this object to translate 
	 */
