...
import dellemuse.serverdb.importer.ArtWorkImporter;
...
*/
    ...
    public ArtWork deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JacksonException {
        ...
        try (InputStream is = new FileInputStream(file)) {
                    this.artWorkImporter.getObjectStorageService().putObject( ServerDBConstant.MEDIA_BUCKET, objectName , is, file.getName());                    
        }
