...
/**
 * <p>
 * State machine of the Status of all Odilon´s system services
 * ({@link SystemService})
 * </p>
 * 
...
public enum ServiceStatus {
    ...
    STOPPED("stopped", 0), STARTING("starting", 1), RUNNING("running", 2), STOPPING("stopping", 3);
