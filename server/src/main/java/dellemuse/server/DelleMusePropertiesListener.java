 ...
 */
public class DelleMusePropertiesListener implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {
			
	@SuppressWarnings("unused")
	static private Logger logger = Logger.getLogger(DelleMusePropertiesListener.class.getName());
