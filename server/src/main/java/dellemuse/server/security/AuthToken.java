 ...
 */
public class AuthToken extends JsonObject implements Serializable {
    ...
    public AuthToken(String bucketName, String objectName) {
        this(bucketName, objectName, OffsetDateTime.now().plusSeconds(Constant.DEFAULT_EXPIRY_TIME), VERSION);
    }
    ...
    public AuthToken(String bucketName, String objectName, int durationSeconds) {
        this(bucketName, objectName, (durationSeconds > 0) ? OffsetDateTime.now().plusSeconds(durationSeconds)
                : OffsetDateTime.now().plusSeconds(Constant.DEFAULT_EXPIRY_TIME), VERSION);
    }
