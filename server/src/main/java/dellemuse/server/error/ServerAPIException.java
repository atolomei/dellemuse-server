...
public class ServerAPIException extends RuntimeException {
    ...
    static private Logger logger = Logger.getLogger(ServerAPIException.class.getName());
    ...
    public ServerAPIException(HttpStatus httpStatus, ErrorCode error) {
    ...
    public ServerAPIException(HttpStatus httpStatus, ErrorCode error, String... parameter) {
    ...
    public ServerAPIException(ErrorProxy proxy) {
    ...
    public ServerAPIException(HttpStatus httpStatus, ErrorCode error, Exception e) {
    ...
    public ServerAPIException(HttpStatus httpStatus, ErrorCode error, Exception e, String msg) {
        super(buildMessage(e.getClass().getName(), msg));
        this.errorCode = error.getCode();
        this.httpStatus = httpStatus.value();
        this.errorMessage = super.getMessage();
    }
